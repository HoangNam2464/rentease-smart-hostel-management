...
urlpatterns = [
    ...
    path('owner/properties/', views.owner_properties_list, name='owner_properties_list'),
    ...
    path('owner/properties/<int:pk>/', views.owner_property_detail, name='owner_property_detail'),
    ...
    path('owner/invoices/<int:pk>/delete/', views.owner_invoice_delete, name='owner_invoice_delete'),
    ...
    path('owner/viewing-registrations/<int:pk>/onboard/', views.owner_viewing_registration_onboard, name='owner_viewing_registration_onboard'),
