...
urlpatterns = [
    ...
    path('owner/rooms/new/', views.owner_room_create, name='owner_room_create'),
    ...
    path('owner/contracts/new/', views.owner_contract_create, name='owner_contract_create'),
    path('owner/contracts/<int:pk>/edit/', views.owner_contract_update, name='owner_contract_update'),
    ...
    path('owner/listings/new/', views.owner_listing_create, name='owner_listing_create'),
    path('owner/listings/<int:pk>/edit/', views.owner_listing_update, name='owner_listing_update'),
