...
MIDDLEWARE = [
    ...
    'portal.middleware.DevAutoAuthBypassMiddleware',
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "accounts.UserProfile": "fas fa-user-tie",
        "properties.Room": "fas fa-door-open",
        "tenants.Tenant": "fas fa-id-card",
        "tenants.CoTenant": "fas fa-user-friends",
        "contracts.Contract": "fas fa-file-contract",
        "billing.PriceConfig": "fas fa-sliders-h",
        "billing.Invoice": "fas fa-file-invoice-dollar",
        "billing.PaymentHistory": "fas fa-money-check-alt",
        "maintenance.RepairRequest": "fas fa-tools",
        "maintenance.MaintenanceRecord": "fas fa-clipboard-check",
        "maintenance.Notification": "fas fa-bell",
        "listings.RoomListing": "fas fa-bullhorn",
        "listings.ViewingRegistration": "fas fa-calendar-plus",
